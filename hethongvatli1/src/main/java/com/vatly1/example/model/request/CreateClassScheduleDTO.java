...
public class CreateClassScheduleDTO {
    ...
    @NotNull(message = "Thứ trong tuần không được để trống (2: Thứ 2 -> 8: Chủ Nhật)")
    ...
    @Schema(description = "Loại buổi học (THEORY, LAB, EXERCISE, EXAM)", example = "THEORY")
    private LessonType lessonType;

    @Schema(description = "Ghi chú thêm", example = "Yêu cầu mang theo giáo trình và máy tính bỏ túi")
